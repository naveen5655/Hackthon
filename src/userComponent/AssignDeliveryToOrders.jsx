...
const AssignDeliveryToOrders = () => {
  ...
  const retrieveAllDeliveryPerson = async () => {
    const response = await axios.get(
      "http://naveensdp3.us-east-1.elasticbeanstalk.com/api/user/deliveryperson/all"
    );
  ...
  const assignDeliveryToOrders = (e) => {
    fetch("http://naveensdp3.us-east-1.elasticbeanstalk.com/api/user/admin/order/assignDelivery", {
      method: "POST",
      headers: {
